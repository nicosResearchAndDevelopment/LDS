...
|-------------|---------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **foaf**    |                           |                                      |                                                                                                                 |                                                                                                                                                              |
|             | `foaf:dnaChecksum`        | `rdfs:Literal`                       | *none* ...but this will come soon ;-)                                                                           | [`foaf:`](#foaf) says > "A checksum for the DNA of some thing. [Joke](https://github.com/nicosResearchAndDevelopment/LDS/tree/main/example/foaf/dnaChecksum)." |
| **did**     |                           |                                      |                                                                                                                 |                                                                                                                                                              |
...
- **foaf:dnaChecksum-builder**: <[https://github.com/nicosResearchAndDevelopment/LDS/tree/main/example/foaf/dnaChecksum](https://github.com/nicosResearchAndDevelopment/LDS/tree/main/example/foaf/dnaChecksum)>
---